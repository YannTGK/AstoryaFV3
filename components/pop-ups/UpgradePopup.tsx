...
type Props = {
  /** sluit de modal na upgrade of “maybe later” */
  onClose: () => void;
};
...
export default function UpgradePopup({ onClose }: Props) {
  ...
  /* ───────── upgrade (PUT /users/:id) ───────── */
  const handleUpgrade = async () => {
    if (!user || loading) return;
    try {
      setLoading(true);
      await api.put(`/users/${user._id}`, { plan: "LEGACY" });
      setUser({ ...user, plan: "LEGACY" });   // store bijwerken
          ...
          >
            ...
            {showBasic ? (
              ...
              <>
                ...
                <TouchableOpacity style={styles.tryBtn} onPress={handleUpgrade} disabled={loading}>
...
/* ───────── styles (ongewijzigd behalve knoppen disabled) ───────── */
const styles = StyleSheet.create({
  overlay: { ...StyleSheet.absoluteFillObject, zIndex: 999, justifyContent: "center", alignItems: "center" },
  popupWrapper: { maxHeight: height - 110, marginBottom: 55, justifyContent: "center", alignItems: "center" },
  popup: { width: width * 0.9, backgroundColor: "#fff", borderRadius: 20, maxHeight: height * 0.8 },
  scrollContent: { paddingVertical: 26, paddingHorizontal: 20, alignItems: "center", flexGrow: 1 },
  heading: { fontFamily: "Alice-Regular", fontSize: 18, textAlign: "center", color: "#273166", marginBottom: 12 },
  planTitle: { fontFamily: "Alice-Regular", fontSize: 20, textAlign: "center", color: "#273166", marginTop: 8 },
  planPrice: { fontSize: 18, color: "#008B7C", fontFamily: "Alice-Regular", marginVertical: 8, textAlign: "center" },
  perMonth: { fontSize: 14, color: "#333" }, oneTime: { fontSize: 14, color: "#333" },
  list: { alignSelf: "stretch", marginVertical: 8, paddingLeft: 10 },
  listItem: { fontSize: 14, color: "#273166", marginVertical: 4, fontFamily: "Alice-Regular", lineHeight: 20 },
  tryBtn: { backgroundColor: "#FEE8A0", borderRadius: 8, paddingVertical: 14, width: "100%", marginTop: 10, alignItems: "center" },
  ...
  line: { flex: 1, height: 1, backgroundColor: "#ccc" }, or: { marginHorizontal: 12, color: "#666", fontSize: 14 },
  upgradeBtn: { backgroundColor: "#11152A", paddingVertical: 14, borderRadius: 8, width: "100%", marginTop: 12, alignItems: "center" },
  upgradeText: { color: "#fff", fontSize: 16, fontFamily: "Alice-Regular" },
  secondaryLink: { marginTop: 12, fontSize: 14, textDecorationLine: "underline", color: "#273166", fontFamily: "Alice-Regular" },
  button: { backgroundColor: "#11152A", paddingVertical: 14, borderRadius: 12, marginTop: 20, width: "100%", alignItems: "center" },
