...
export default function DeleteMessage() {
  ...
  const simulateDelete = () => {
    ...
    setSelectedMessages([]);
    setSelectAll(false);
    router.replace("/(app)/my-stars/private-star/messages/add-message");
  };
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <TouchableOpacity
        ...
        onPress={() => selectedMessages.length > 0 && setShowDeletePopup(true)}
        disabled={selectedMessages.length === 0}
      >
        <View style={styles.deleteTextRow}>
          <DeleteIcon width={16} height={16} style={{ marginRight: 6 }} />
          <Text style={styles.deleteText}>
            {selectedMessages.length} message
            {selectedMessages.length !== 1 ? "s" : ""} selected for deletion
          </Text>
        </View>
      </TouchableOpacity>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalBox}>
            ...
            <View style={styles.modalButtons}>
              ...
              <TouchableOpacity style={styles.modalButton} onPress={simulateDelete}>
