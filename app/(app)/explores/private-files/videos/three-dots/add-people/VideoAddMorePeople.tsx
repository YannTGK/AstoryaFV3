...
export default function AddMorePeople() {
  ...
  const addContacts = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        router.push({
          pathname:
            "/(app)/explores/private-files/videos/three-dots/add-people/VideoAddPeoplePage",
  ...
  /* ---------- invite knop ---------- */
  const invite = () =>
    router.push("/(app)/explores/private-files/videos/three-dots/add-people/Videosend-invitation-photos");
