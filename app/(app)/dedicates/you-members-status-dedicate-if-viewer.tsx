...
export default function YouMembersStatusDedicateViewer() {
  ...
  const [selectedRequest, setSelectedRequest] = useState<"edit" | "admin" | null>(null);

  const handleRequestPress = (type: "edit" | "admin") => {
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 80 }}>
        ...
        <View style={styles.statusWrapper}>
          ...
          <View style={styles.statusInput}>
            <Text style={styles.statusText}>Can view</Text>
          </View>
        </View>
        ...
        <View style={styles.requestWrapper}>
          ...
          <View style={styles.buttonsRow}>
            <TouchableOpacity
              style={[
                styles.requestButtonLeft,
                requestSent && styles.disabledButton,
              ]}
              disabled={requestSent}
              onPress={() => handleRequestPress("edit")}
            >
              <Text
                style={[
                  styles.requestButtonTextLeft,
            ...
            <TouchableOpacity
              style={[
                styles.requestButtonRight,
                requestSent && styles.disabledButton,
              ]}
              disabled={requestSent}
              onPress={() => handleRequestPress("admin")}
            >
              <Text
                style={[
                  styles.requestButtonTextRight,
                  requestSent && styles.disabledButtonText,
                ]}
              >
                Admin request
        ...
        <View style={styles.popupOverlay}>
          <View style={styles.popupBox}>
            <Text style={styles.popupText}>
              ...
              You’ll be notified once your request has been reviewed and approved.
            </Text>
...
const styles = StyleSheet.create({
  ...
  requestButtonTextLeft: {
    fontFamily: "Alice-Regular",
    fontSize: 14,
    color: "#11152A",
  },
  requestButtonTextRight: {
    fontFamily: "Alice-Regular",
    fontSize: 14,
    color: "#fff",
  },
