...
export default function CreatedVideoAlbum() {
  ...
  const openActionScreen = (type: "copy" | "move") => {
    ...
    router.push({
      pathname:
        type === "copy"
          ? "/(app)/dedicates/created-dedicates/videos/three-dots/copy-album/selected-album"
          : "/(app)/dedicates/created-dedicates/videos/three-dots/move-album/move-album",
      params: {
        id: starId,
        albumId,
      ...
      {menuOpen && (
        <View style={styles.menuBox}>
          <MenuItem label="Add people" icon="user-plus" onPress={() => router.push({
            pathname: "/(app)/dedicates/created-dedicates/videos/three-dots/add-people/VideoAddPeoplePage",
            params: { id: starId, albumId, albumName },
          })} />
          <MenuItem label="See members" icon="users" onPress={() => router.push({
            pathname: "/(app)/dedicates/created-dedicates/videos/three-dots/see-members/SeeMembersVideo",
            params: { id: starId, albumId, albumName },
          })} />
