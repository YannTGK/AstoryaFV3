...
export default function AddMorePeople() {
  ...
  const addContacts = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        router.push({
          pathname:
            "/(app)/dedicates/created-dedicates/videos/three-dots/add-people/VideoAddPeoplePage",
  ...
  /* ---------- invite knop ---------- */
  const invite = () =>
    router.push("/(app)/dedicates/created-dedicates/videos/three-dots/add-people/Videosend-invitation-photos");
