...
export default function AddPeopleDedicate() {
  ...
  const selectOne = (id: string) => {
    // als deze al geselecteerd is, deselecteer; anders selecteer alleen deze
  ...
  const next = () => {
    ...
    router.push({
      pathname:
        "/dedicates/created-dedicates/add-people/add-selected-people-dedicate",
      params: {
        starId,
        userId: c._id,
        username: c.username,
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <Text style={styles.subtitle}>
        Select contacts to add to the star. To add someone new, tap the plus
        icon.
      </Text>
        ...
        <ScrollView style={{ marginTop: 20, marginBottom: 180 }}>
          {contacts.map((c) => (
            <TouchableOpacity
              ...
              style={[
                styles.option,
                selected === c._id && styles.selectedOption,
              ]}
